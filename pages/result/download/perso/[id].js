...
function ResultDownload({ user, formDataInitial }) {
  ...
  return (
    <div className="w-screen h-screen">
      <Head>
        <title>Résultat du Diagnostic Personnelle</title>
      ...
      {formData && user && (
        ...
        <main className={`${styles.main} flex-col bg-[#F9EEE8]`} id="toBeDownloaded">
          <div className="w-full h-screen flex items-center justify-center font-semibold font-AnticDidone text-3xl p-80 text-center flex-col gap-10"><span className="text-7xl">Résultat QVT Personnelle</span> <span className="text-green-900">{user.username}</span></div>
